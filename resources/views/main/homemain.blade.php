...
<body>
                ...
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <p id="more" class="showless">
                            ...
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Asperiores cum voluptatum harum
                            distinctio architecto nam! Quos voluptatum illo nemo! Ratione tenetur maxime excepturi
                            commodi voluptatum, dolore fuga esse deleniti qui!
                        </p>
    ...
    {{-- jquery خاصية المزيد باستخدام  --}}
    <script>
        $(document).ready(function() {
            $('#btn').click(function() {
                $('#more').toggleClass('showless');
                var isfound = $('#more').hasClass('showless');
                // تغيير الاسم من المزيد الى عناصر اقل 
                if (isfound) {
                    $('#btn').text('Read More');
                } else {
                    $('#btn').text('Less');
